										...
										<div class="auth-form-wrapper px-4 py-5">
											...
											<form class="forms-sample" action="VerifyLogin" method="post">
												...
												<div class="form-group">
													...
													<input type="password" class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Password" required name="password">
												</div>
												<!--
												...
												-->
												<div class="mt-3">
													<button type="submit" class="btn btn-primary mr-2 mb-2 mb-md-0 text-white" style="width:100%;">Login</button>

													<a href="{{ route('forgot_password') }}" type="button" class="btn mb-2 mb-md-0" style="border:none;text-align:right;width:100%;margin-top:15px;color:#5E50F9;">
													Forgot password?
													</a>
