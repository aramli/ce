            ...
            <div
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
                        <form id="bypass_login" class="forms-sample" action="../../../../public/VerifyLogin"
                            method="post">
                            {{ csrf_field() }}
                            <!--begin::Title-->
                            ...
                            <div style="margin-bottom:20px;">
                                <?php
									...
									?>
                                <span
                                    class="badge badge-<?php echo $alert_color;?>">{{ Session::get('popup_message') }}</span>
                            </div>
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="submit"
                                    onclick="VerifyLogin(document.getElementById('email').value, document.getElementById('password').value);"
