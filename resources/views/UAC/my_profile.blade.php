						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Your Profile</h5>
									<!--end::Title-->
									<!--begin::Separator-->
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="inputFullname" type="text" value="{{ $this_user->use_FULLNAME }}" disabled />
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="inputEmail" type="email" value="{{ $this_user->use_EMAIL }}" disabled />
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="text" value="{{ $this_user->com_NAME }}" disabled class="form-control" />
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="text" value="{{ $this_user->div_NAME }}" disabled class="form-control" />
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="text" value="{{ $this_user->rol_NAME }}" disabled class="form-control" />
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="text" value="<?php if( $this_user->use_IS_ACTIVE == 1 ){ echo 'Active';} else { echo 'Not Active'; } ?>" disabled class="form-control" />
																				</div>
																			</div>
																			<!--end::Group-->


																			<div class="alert alert-custom alert-default" role="alert" style="margin-top:0px!important;visibility:hidden;">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="numberTargetTraining" type="text" value="{{ $this_user->use_TRAINING_TARGET }}" disabled />
																				</div>
																			</div>
																			<!--end::Group-->
