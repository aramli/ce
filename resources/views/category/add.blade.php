...
@section('content')
			<form action="SaveNewCategory" method="post" class="forms-sample">
				{{ csrf_field() }}
				<div class="page-content">
					<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
						<div>
							<h4 class="mb-3 mb-md-0">Add New Event Category</h4>
						</div>
					...
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h6 class="card-title">Category Detail Information</h6>
										
									<div class="form-group m-form__group">
										<label for="example_input_full_name"><span style="color:red;">*</span> Name:</label>
										<input type="text" class="form-control m-input" placeholder="Enter category name" value="" name="NAME" required >
									</div>
									<div class="form-group m-form__group">
