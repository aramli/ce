									...
									<div class="table-responsive">
									    ...
									    // This example adds C3 chart renderers.
										    ...
										    $(function(){
										        ...
										        $.getJSON("<?php echo asset('SYSTEM/reporting/energy__today_energy_consumption.json'); ?>", function(mps) {
										            $("#output").pivotUI(mps, {
										                renderers: renderers,
										                // cols: ["ORGANIZER", "COMPANY", "DIVISION", "CATEGORY"], 
										                rows: ["ORGANIZER", "COMPANY", "DIVISION", "CATEGORY", "ENERGY CONSUMPTION (kWh)"],
