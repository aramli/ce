    		...
    		display:none;
				...
				<div class="page-content">
					<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
						<div>
							<h4 class="mb-3 mb-md-0">Report - Today Energy Consumption</h4>
						</div>
									...
									<div class="table-responsive">
									    ...
									    // This example adds C3 chart renderers.
										    ...
										    $(function(){
										        ...
										        $.getJSON("<?php echo asset('SYSTEM/reporting/energy__over_consumption_event.json'); ?>", function(mps) {
										            $("#output").pivotUI(mps, {
										                renderers: renderers,
										                // cols: ["ORGANIZER", "COMPANY", "DIVISION", "CATEGORY"], 
										                rows: ["ORGANIZER", "COMPANY", "DIVISION", "CATEGORY", "FORECAST CONSUMPTION (kWh)", "ENERGY CONSUMPTION (kWh)"],
