						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Company</h5>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<div class="d-flex align-items-center" id="kt_subheader_search">
										<span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ $this_company->com_NAME }}</span>
									</div>
									<!--end::Search Form-->
								</div>
								<!--end::Details-->
										...
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a href="../../../../public/company/detail/{{ $this_company->com_ID }}/delete" class="btn btn-danger" style="color:#fff;">Yes, Delete</a>
												</div>
											</div>
										</div>
									</div>
												...
												<div class="card-body p-0">
													<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
														<div class="col-xl-12 col-xxl-10">
															<!--begin::Wizard Form-->
															<form class="form" id="kt_form" method="post" action="../../../../public/company/UpdateCompanyDetail">
																{{ csrf_field() }}
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="NAME" placeholder="Ex: Sample Company 1" type="text" value="{{ $this_company->com_NAME }}" required />
																				</div>
																			</div>
																			<!--end::Group-->
																		</div>
																...
																<input type="hidden" name="currentID" value="{{ $this_company->com_ID }}" />
																<input type="hidden" name="currentName" value="{{ $this_company->com_NAME }}" />
															</form>
															<!--end::Wizard Form-->
														</div>
													</div>
...
<script>
	function UpdateExistingCompany(){
