																	...
																	<div class="col-xl-9">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="alert alert-custom alert-default" role="alert" style="margin-top:25px!important;margin-bottom:25px;">
																				...
																				<div class="alert-text">Please fill the address carefully. Make sure that you know the exact address you are about to fill in..</div>
																										
																			</div>

																			<h5 class="text-dark font-weight-bold mb-10">Device setting:</h5>
																			...
																			<div>
																				<table class="table">
																					...
																					<tbody>
																						<tr>
																							<td>Electricity</td>
																							<td><input class="form-control" type="number" name="roo_KWH_ADDRESS" value="{{ $this_room->roo_KWH_ADDRESS }}" placeholder="109" /></td>
																							<td><input class="form-control" type="number" name="roo_POWER_ADDRESS" value="{{ $this_room->roo_POWER_ADDRESS }}" placeholder="111" /></td>
																						</tr>
																						<tr>
																							<td>Air Conditioner</td>
																							<td><input class="form-control" type="number" name="roo_KWH_ADDRESS_AC" value="{{ $this_room->roo_KWH_ADDRESS_AC }}" placeholder="113" /></td>
																							<td><input class="form-control" type="number" name="roo_POWER_ADDRESS_AC" value="{{ $this_room->roo_POWER_ADDRESS_AC }}" placeholder="115" /></td>
																						</tr>
																						<tr>
																							<td>Blinker</td>
																							<td colspan="2"><input class="form-control" type="number" name="roo_BLINKING_ADDRESS" value="{{ $this_room->roo_BLINKING_ADDRESS }}" placeholder="117" /></td>
																						</tr>
																					</tbody>
																				</table>
																			</div>
