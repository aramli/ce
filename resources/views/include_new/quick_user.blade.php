...
<div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('https://www.pngkit.com/png/full/302-3022217_roger-berry-avatar-placeholder.png')"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="{{ route('logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" style="width:100%;">Sign Out</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
				...
				<div>
					<!--begin:Heading-->
					<h5 class="mb-5">Your Recent Events</h5>
					<!--end:Heading-->
					<div id="div_your_recent_events">
						<!--begin::Item-->
		...
		<script>
			...
			xhttp.send("module=GetUserRecentEvent&ID_USER=<?php echo Session::get('ID'); ?>");
		</script>