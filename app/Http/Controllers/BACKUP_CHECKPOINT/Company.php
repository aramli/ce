...
class Company extends Controller
{
    ...
    public function SaveNewCompany(Request $request){
        ...
        if( $check == 0 ){
            ...
            Session::put('popup_message', 'New company has been successfully registered to the system.');

            return redirect('/company/detail/'.$new_id);
        } else {
            Session::put('popup_status', 1);
    ...
    public function UpdateCompanyDetail(Request $request){
		...
		if( $check_name > 0 ){
            ...
            Session::put('popup_type', 'success');
            Session::put('popup_title', 'Success');
            Session::put('popup_message', 'Company has been successfully updated.');
		}

	

    	return redirect('/company/detail/'.$request->currentID);
    ...
    public function DeleteCompany($id){
        ...
        Session::put('popup_message', 'Company has been erased.');
